...
| ID | Item | Size | Status |
|----|------|------|--------|
| B-004 | Add request timeout to TiinyClient | S | Executable |
| B-005 | Add --verbose flag for debug output | S | Executable |
| B-006 | Guard against symlink traversal in bundle mode (REQ-SEC-005) | S | Executable |
